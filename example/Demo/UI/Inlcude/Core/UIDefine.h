...
//////////////BEGIN WINDOWS消息映射宏定义//////////////////////////////////////////

#define DUI_WIN_BEGIN_MSG_MAP(theClass, baseClass)                        \
public:                                                                   \
    virtual LRESULT ProcessWindowMessage(_In_ UINT uMsg, _In_ WPARAM      \
        wParam, _In_ LPARAM lParam, _In_ BOOL& bHandled)                  \
    {                                                                     \
...
#define DUI_WIN_MESSAGE_HANDLER(msg, func)                                \
        if(uMsg == msg)                                                   \
        {                                                                 \
            bHandled = TRUE;                                              \
...
#define DUI_WIN_END_MSG_MAP()                                             \
        return Base::ProcessWindowMessage(uMsg, wParam, lParam, bHandled);\
    }
